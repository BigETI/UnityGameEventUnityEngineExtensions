...
{
    /// <summary>
    /// A class that describes a "UnityEngine" game event name invoker controller script
    /// </summary>
    public class UnityEngineGameEventNameInvokerControllerScript : GameEventNameInvokerControllerScript, IUnityEngineGameEventNameInvokerController
    {
        /// <summary>
