...
{
    /// <summary>
    /// An interface that represents an "UnityEngine" game event name invoker controller
    /// </summary>
    public interface IUnityEngineGameEventNameInvokerController : IGameEventNameInvokerController
    {
        /// <summary>
